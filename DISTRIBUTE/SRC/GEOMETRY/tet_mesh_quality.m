function qmesh=tet_mesh_quality( node_xyz, tetra_node, is_log)

% %**********************************************************************************************80
% % This code was adapted for the MRI application by Van-Dang Nguyen on Dec 07 2018
% % 
% % Original version: https://people.sc.fsu.edu/~jburkardt/m_src/tet_mesh_quality/tet_mesh_quality.html
% %  Licensing:
% %
...
% % * Measure 1, the minimum, over all tetrahedrons, of 3 times the radius of the insphere divided by the radius of the circumsphere.
% % * Measure 2, the minimum, over all tetrahedrons, of 2 times sqrt ( 6 ) times the radius of the insphere divided by the length of the longest side of the tetrahedron.
% % * Measure 3, the minimum, over all tetrahedrons, of 12 * ( 3 * volume )**(2/3) / (sum of squares of edge lengths);
% % * Measure 4, the minimum solid angle in any tetrahedron;
% % * Measure 5, a uniformity measure, the ratio of the maximum to minimum tetrahedron volume;

  [tetra_order,tetra_num]=size(tetra_node);  
  [dim_num, node_num]=size(node_xyz);
  
%  Compute and print the quality measures.
%
  [ value_min, value_mean, value_max, value_var, tetrahedron_hout, tetrahedron_hin] = ...
    tet_mesh_quality1 ( node_xyz, tetra_num, ...
    tetra_node );
   qmesh.quality1=[value_min, value_mean, value_max, value_var];
   qmesh.hout = tetrahedron_hout;
   qmesh.hin = tetrahedron_hin;
  ...
  [ value_min, value_mean, value_max, value_var ] = ...
   ...
   qmesh.quality2=[value_min, value_mean, value_max, value_var];
  ...
  [ value_min, value_mean, value_max, value_var ] = ...
   ...
   qmesh.quality3=[value_min, value_mean, value_max, value_var];
  ...
  [ value_min, value_mean, value_max, value_var ] = ...
   ...
   qmesh.quality4=[value_min, value_mean, value_max, value_var];
...
function [ value_min, value_mean, value_max, value_var, tetrahedron_hout, tetrahedron_hin] = ...
